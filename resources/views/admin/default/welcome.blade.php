...
<!--[if IE 6]>
<script type="text/javascript" src="{{asset('js/backend/lib/DD_belatedPNG_0.0.8a-min.js')}}" ></script>
...
<footer class="footer mt-20">
	<div class="container">
		<p>感谢jQuery、layer、laypage、Validform、UEditor、My97DatePicker、iconfont、Datatables、WebUploaded、icheck、highcharts、bootstrap-Switch<br>
			...
			本后台系统由<a href="{{asset('http://www.h-ui.net/')}}" target="_blank" title="H-ui前端框架">H-ui前端框架</a>提供前端技术支持</p>
	</div>
</footer>
