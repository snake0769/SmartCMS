...
<LINK rel="Bookmark" href="{{asset('js/backend//favicon.ico')}}" >
<LINK rel="Shortcut Icon" href="{{asset('js/backend//favicon.ico')}}" />
<!--[if lt IE 9]>
...
<script type="text/javascript" src="{{asset('js/backend/lib/jquery.validation/1.14.0/validate-methods.js')}}"></script> 
<script type="text/javascript" src="{{asset('js/backend/lib/jquery.validation/1.14.0/messages_zh.min.js')}}"></script> 
